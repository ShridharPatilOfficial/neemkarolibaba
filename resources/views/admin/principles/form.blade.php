    ...
    <form method="POST" action="{{ $principle ? route('admin.principles.update', $principle) : route('admin.principles.store') }}">
        ...
        <div class="mb-5">
            ...
            <textarea name="description" rows="5" required
                      class="w-full px-4 py-2.5 border border-gray-200 rounded-lg focus:outline-none focus:border-purple-400 text-sm resize-y @error('description') border-red-400 @enderror"
                      placeholder="Full description text shown on the card...">{{ old('description', $principle?->description) }}</textarea>
