    ...
    <form method="POST" action="{{ $msg ? route('admin.president.update', $msg) : route('admin.president.store') }}" enctype="multipart/form-data">
        ...
        <div class="mb-5">
            ...
            <textarea name="message" rows="7" required
                      class="w-full px-4 py-2.5 border border-gray-200 rounded-lg focus:outline-none focus:border-purple-400 text-sm resize-y @error('message') border-red-400 @enderror"
                      placeholder="President's message...">{{ old('message', $msg?->message) }}</textarea>
